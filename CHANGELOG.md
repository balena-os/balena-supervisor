...
* Allow custom configuration for Compulab EdgeAI Orin NX 16GB [Alexandru Costache]

# v19.2.0
## (2026-09-17)

* Allow compose bind mounts for host paths under /tmp [Shaun Mulligan]
* Centralise the supervisor host /tmp directory [Shaun Mulligan]

# v19.1.4
## (2026-09-09)

* Allow custom configuration for Jetson AGX Thor Developer Kit [Alexandru Costache]

# v19.1.3
## (2026-08-27)

* Detect stale image entries when a service is rebuilt under the same name [Chase Busacker]
* Fix markAsSupervised() upserting a new image row on every rebuild [Chase Busacker]

# v19.1.2
## (2026-08-26)

* Migrate Flowzone caller off pull_request_target [Christina Ying Wang]

# v19.1.1
## (2026-08-26)

* Make the default network config-only for none networking too [Christina Ying Wang]

# v19.1.0
## (2026-08-25)

* Update helios to v0.26.3 [Felipe Lalanne]
* Support unix sockets for api endpoint [Felipe Lalanne]

# v19.0.11
## (2026-08-24)

* Revert "Migrate Flowzone caller off pull_request_target" [Felipe Lalanne]

# v19.0.10
## (2026-08-24)

* Use the 10.114.105.x subnet for supervisor services [Felipe Lalanne]
...
* compose: do not sweep overlay extension volumes [Alex Gonzalez]
* compose: only treat appId-prefixed volumes as supervisor-managed [Alex Gonzalez]

# v19.0.7
## (2026-08-10)

* fix documentation GET host-config json [Yann CARDAILLAC]

# v19.0.6
## (2026-08-10)

* Update debian docker image dependency to stable-slim [Felipe Lalanne]

# v19.0.5
## (2026-08-05)

* Update helios to v0.25.28 [Felipe Lalanne]

# v19.0.4
## (2026-07-31)

* Add kill step for handover services without target [Felipe Lalanne]
* Write regression test for interrupted handover issue [Felipe Lalanne]

# v19.0.3
## (2026-07-30)

* Use `/tmp` as host runtime dir [Felipe Lalanne]

# v19.0.2
## (2026-07-29)

* Set core-next restart policy to always [Felipe Lalanne]
* Do not send socat logs to the API [Felipe Lalanne]
* Update helios to 0.25.26 [Felipe Lalanne]

# v19.0.1
## (2026-07-27)

* Update helios to v0.25.24 [Ken Bannister]
